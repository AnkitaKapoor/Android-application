...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.places_item);

        showPlace = (Button) findViewById(R.id.showPlaces);
        showPlaceTv = (TextView) findViewById(R.id.textView2);
        showAddressTv = (TextView) findViewById(R.id.textView);
    ...
    public void getDescriptionPlace()
    {
        ...
        result.setResultCallback( new ResultCallback<PlaceLikelihoodBuffer>() {
            ...
            public void onResult( PlaceLikelihoodBuffer likelyPlaces ) {
                if (likelyPlaces.getStatus().isSuccess()) {
                    ...
                    //Toast.makeText(placesActivity.this, "No places found ", Toast.LENGTH_SHORT).show();
