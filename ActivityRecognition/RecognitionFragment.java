 ...
 */
public class RecognitionFragment extends Fragment implements
        ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<Status>, OnMapReadyCallback,  LocationListener {

    protected static final String TAG = "RecognitionFragment";
    ...
    {
        rootView = inflater.inflate(R.layout.recognition_main_activity, container, false);
        ...
        // Get the UI widgets.
        mRequestActivityUpdatesButton = (Button) rootView.findViewById(R.id.request_activity_updates_button);
        mRemoveActivityUpdatesButton = (Button) rootView.findViewById(R.id.remove_activity_updates_button);
        mDetectedActivitiesListView = (ListView) rootView.findViewById(R.id.detected_activities_listview);
        ...
        Button button1 = (Button) rootView.findViewById(R.id.request_activity_updates_button);
        button1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                if (!mGoogleApiClient.isConnected()) {
                    Toast.makeText(getActivity(), getActivity().getString(R.string.not_connected),
        ...
        Button button2 = (Button) rootView.findViewById(R.id.remove_activity_updates_button);
    ...
    public void requestActivityUpdatesButtonHandler(View view) {
        if (!mGoogleApiClient.isConnected()) {
            Toast.makeText(getActivity(), super.getActivity().getString(R.string.not_connected),
                    Toast.LENGTH_SHORT).show();
            return;
        }
        ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates(
    ...
    public void removeActivityUpdatesButtonHandler(View view) {
        if (!mGoogleApiClient.isConnected()) {
            Toast.makeText(getActivity(), super.getActivity().getString(R.string.not_connected), Toast.LENGTH_SHORT).show();
            return;
        }
        // Remove all activity updates for the PendingIntent that was used to request activity
        // updates.
    ...
    private SharedPreferences getSharedPreferencesInstance() {
        return super.getActivity().getSharedPreferences(Constants.SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE);
    }
